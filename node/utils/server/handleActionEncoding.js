...
function handleWithdrawEncoding(encoding) {
    return __awaiter(this, void 0, void 0, function () {
        var actionViaSignatureStruct;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    actionViaSignatureStruct = actionViaSignatureStructUtils_1.actionViaSignatureStructUtils.fromEncoding(encoding);
                    return [4 /*yield*/, engineWriter_1.engineWriter.withdrawViaSignature(actionViaSignatureStruct)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
exports.handleWithdrawEncoding = handleWithdrawEncoding;
function handleWithdrawAndNotifyEncoding(encoding) {
    return __awaiter(this, void 0, void 0, function () {
        var actionViaSignatureStruct;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    actionViaSignatureStruct = actionViaSignatureStructUtils_1.actionViaSignatureStructUtils.fromEncoding(encoding);
                    return [4 /*yield*/, engineWriter_1.engineWriter.withdrawAndNotifyViaSignature(actionViaSignatureStruct)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
exports.handleWithdrawAndNotifyEncoding = handleWithdrawAndNotifyEncoding;
