...
var FastProvider = /** @class */ (function (_super) {
    __extends(FastProvider, _super);
    ...
    return FastProvider;
}(ethers_1.ethers.providers.InfuraProvider));
exports.provider = new FastProvider('homestead', process.env.INFURA_ID);
