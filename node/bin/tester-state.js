...
function run() {
    return __awaiter(this, void 0, void 0, function () {
        var daiBalance, daiAllowance, engineDaiBalance;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log('dianthusTester', pollenium_xeranthemum_1.users.dianthusTester.toHex());
